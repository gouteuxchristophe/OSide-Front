                ...
                <div>
                  <form onSubmit={handleUpdateUserSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="mb-2 sm:mb-6 flex flex-col items-center justify-center sm:gap-5 w-full">
                      ...
                      <input onChange={(e) => setUpdateContent(e.currentTarget.value)} defaultValue={project?.status} type="text" className="shadow-sm text-sm rounded block p-2.5 sm:w-[40%]" placeholder="Status" />
                    </div>
