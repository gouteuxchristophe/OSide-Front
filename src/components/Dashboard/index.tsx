    ...
    <div className="px-6 py-8">
      <div className="w-[90%] mx-auto rounded-lg shadow relative bg-secondary20">
        <div className="flex justify-end px-4 pt-4">
          ...
          <div className={`z-10 ${showMenu ? 'visible' : 'hidden'} text-base list-none rounded shadow w-22 absolute right-[25%] flex gap-2`}>
            <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-[white] bg-primary0 rounded-lg focus:ring-4 focus:outline-none">Update</button>
            <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-[white] bg-[red] rounded-lg focus:ring-4 focus:outline-none">Delete</button>
          </div>
        </div>
